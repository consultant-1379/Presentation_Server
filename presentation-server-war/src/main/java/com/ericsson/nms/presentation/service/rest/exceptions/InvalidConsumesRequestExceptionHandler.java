...
import com.ericsson.nms.presentation.exceptions.InvalidConsumesRequestException;
 ...
 */
public class InvalidConsumesRequestExceptionHandler implements ExceptionMapper<InvalidConsumesRequestException> {

    @Inject
    Logger logger;

    @Override
    public Response toResponse(final InvalidConsumesRequestException exception) {
