...
EAR_SEARCH_PATTERN="presentation-server"
...
for ui_instance in ${LITP_SU_LIST}; do
	...
	JBOSS_CLI="${JBOSS_ROOT}/${LITP_COMPONENT_NAME}_${ui_instance}_jee_cfg/bin/jboss-cli.sh --controller=${UI_INSTANCE_IP_ADDRESS} -c --command=\"deploy -l\""
